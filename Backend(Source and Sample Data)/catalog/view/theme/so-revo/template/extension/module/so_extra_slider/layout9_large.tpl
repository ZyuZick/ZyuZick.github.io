...
<div class="modcontent">
	...
	<div class="extraslider-inner products-list grid" data-effect="<?php echo $effect; ?>">
			...
			<div class="item ">
				...
				<?php  
					if( $i%$number_product == 1 ):
						$class_numberProduct = 'first-item';
						$display_numberProduct = true;
					else: 
						$class_numberProduct = 'ex-item';
						$display_numberProduct = false;
					endif;
				?>
				<div class="product-layout <?php echo $products_style.' '. $class_numberProduct; ?>">
					<div class="product-item-container ">
							<div class="left-block so-quickview">
								<div class="product-image-container">
									...
									?>
											<img src="<?php echo $product['image_large']?>" alt="<?php echo $product['nameFull'] ?>">
