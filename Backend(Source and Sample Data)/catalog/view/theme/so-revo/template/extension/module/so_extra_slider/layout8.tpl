<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	<div class="head-title">
		<?php if($disp_title_module) { ?>
			<h2 class="modtitle font-ct"><?php echo $head_name; ?></h2>
		<?php } ?>
		<?php if($pre_text != '')
			{
		?>
			...
			<div class="item ">
				...
				<div class="product-layout <?php echo $products_style; ?>">
					<div class="product-item-container ">
						...
						<?php if($display_title == 1 || $display_description == 1 || $display_price == 1 ||  $display_readmore_link == 1){ ?>
...
<div class="btn-shopall font-ct">
	<a href="#">Shop all now<i class="fa fa-angle-double-right"></i>
	</a>
</div>
<?php if($post_text != '')
{
