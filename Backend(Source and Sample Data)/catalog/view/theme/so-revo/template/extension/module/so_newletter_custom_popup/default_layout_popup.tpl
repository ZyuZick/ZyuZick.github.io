		...
		<div class="modcontent">
            ...
            <div class="socials-popup">                     
                <div class="socials-newsletter font-title">
                    ...
                    <li><a title="title" href="http://www.facebook.com/openfoxx"><i class="fa fa-facebook"></i><span class="hidden">Facebook</span></a></li>
                    <li><a title="title" href="https://twitter.com/openfoxx"><i class="fa fa-twitter"></i><span class="hidden">Twitter</span></a></li>
