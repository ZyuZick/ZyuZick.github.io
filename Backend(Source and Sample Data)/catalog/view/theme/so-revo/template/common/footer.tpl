...
?>
	...
	if(isset($typefooter)){
		...
		case "5":
			...
			break;	
		case "6":
			$footer6 = DIR_TEMPLATE.$theme.'/template/footer/footer6.tpl';
			if (file_exists($footer6)) include($footer6);
			else echo $footer_alert;
			break;	
		case "7":
			$footer7 = DIR_TEMPLATE.$theme.'/template/footer/footer7.tpl';
			if (file_exists($footer7)) include($footer7);
			else echo $footer_alert;
			break;	
		case "8":
			$footer8 = DIR_TEMPLATE.$theme.'/template/footer/footer8.tpl';
			if (file_exists($footer8)) include($footer8);
			else echo $footer_alert;
			break;	
		case "9":
			$footer9 = DIR_TEMPLATE.$theme.'/template/footer/footer9.tpl';
			if (file_exists($footer9)) include($footer9);
			else echo $footer_alert;
			break;	
		case "10":
			$footer10 = DIR_TEMPLATE.$theme.'/template/footer/footer10.tpl';
			if (file_exists($footer10)) include($footer10);
			else echo $footer_alert;
			break;	
		}
	}else{
