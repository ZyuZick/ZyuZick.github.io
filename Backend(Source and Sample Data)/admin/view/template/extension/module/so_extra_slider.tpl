							...
							<div class="tab-pane">
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="product_option"> <?php //<!-- Product Options --> ?>
										...
										<div class="form-group"> <?php //<!-- display viewall link --> ?>
											<label class="col-sm-3 control-label" for="input-display_viewall_link"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_display_viewall_link'); ?>"><?php echo $objlang->get('entry_display_viewall_link'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<label class="radio-inline">
														<?php if ($module['display_viewall_link']) { ?>
														<input type="radio" name="display_viewall_link" value="1" checked="checked" />
														<?php echo $objlang->get('text_yes'); ?>
														<?php } else { ?>
														<input type="radio" name="display_viewall_link" value="1" />
														<?php echo $objlang->get('text_yes'); ?>
														<?php } ?>
													</label>
													<label class="radio-inline">
														<?php if (!$module['display_viewall_link']) { ?>
														<input type="radio" name="display_viewall_link" value="0" checked="checked" />
														<?php echo $objlang->get('text_no'); ?>
														<?php } else { ?>
														<input type="radio" name="display_viewall_link" value="0" />
														<?php echo $objlang->get('text_no'); ?>
														<?php } ?>
													</label>
												</div>
										...
										<div class="form-group"> <?php //<!-- viewall text --> ?>
											<label class="col-sm-3 control-label" for="input-viewall_text"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_viewall_text'); ?>"><?php echo $objlang->get('entry_viewall_text'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<input type="text" name="viewall_text" value="<?php echo $module['viewall_text']; ?>" id="input-viewall_text" class="form-control" />
												</div>
											</div>
										</div>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="effect_option"> <?php //<!-- Effect Options --> ?>
										...
										<div class="form-group"> <?php //<!-- center --> ?>
											<label class="col-sm-3 control-label" for="input-center"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_center'); ?>"><?php echo $objlang->get('entry_center'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<label class="radio-inline">
														<?php if ($module['center']) { ?>
														<input type="radio" name="center" value="1" checked="checked" />
														<?php echo $objlang->get('text_yes'); ?>
														<?php } else { ?>
													...
													<label class="radio-inline">
														<?php if (!$module['center']) { ?>
														<input type="radio" name="center" value="0" checked="checked" />
														<?php echo $objlang->get('text_no'); ?>
														<?php } else { ?>
