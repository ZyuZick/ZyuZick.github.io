							...
							<div class="so-panel">	
								...
								<div class="panel-container">
									...
									<div class="form-group">
										...
										<div class="col-sm-2" >
											<?php echo field_onOff('soconfig_general_store',$soconfig_general_store,'promotion_status'); ?>
										</div>
										<div class="col-sm-8" >
											<?php echo field_langHori($languages,$storeid ,'soconfig_general_store',$soconfig_general_store,'promotion',50);?>
										</div>
									</div>
