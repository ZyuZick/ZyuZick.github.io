        ...
        <div class="tab-content ">
					...
					<div class="panel-container">
						<div id="tab-general__layouttype" class="form-group">
							...
							<div class="col-sm-10 text-center grouplayout">
								<?php echo field_typeheader('mobilelayout',$typelayout,'6'); ?>
							</div>
						</div>
						<div class="form-group" >
							...
							<div class="col-sm-offset-2 col-sm-10">
								 <?php if (isset($error['nameColor'])) { ?>
									  <div class="text-danger"><?php echo $error['nameColor']; ?></div>
								<?php } ?>
							</div>
							<div class="col-sm-offset-2 col-sm-10">
            ...
            <div id="tab-general-layout2" class="tab-pane">
				<div class="so-panel">
					...
					<?php echo field_typeheader('mobileheader',$typeheader); ?>
					</div>
				</div>
