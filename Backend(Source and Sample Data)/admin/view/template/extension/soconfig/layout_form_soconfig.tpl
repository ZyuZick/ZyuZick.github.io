    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
		  ...
		  <?php 
				global $module_row; $module_row = 0;
				if(isset($layout_route['route'])){
					$row_mobile = ($layout_route['route']=='mobile/home') ? 'row-mobile' : '';
				}else{
					$row_mobile = '';
				}
			?>

          <fieldset class="<?php echo $row_mobile; ?>">
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-sm-12 content-mobile">
							<div class="row">
							<div class="col-sm-12"> 
						...
						<style>
						.row-mobile div[class*="col-lg"]{display:none}
						.row-mobile div[class*="col-md"]{display:none}
						.row-mobile div.content-mobile{display:block}
						</style>
						<?php 
						endif;
						}
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block7','footer_block7',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block8','footer_block8',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block9','footer_block9',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block10','footer_block10',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block11','footer_block11',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block12','footer_block12',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block13','footer_block13',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block14','footer_block14',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block15','footer_block15',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block16','footer_block16',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block17','footer_block17',$layout_modules,$extensions,$module_row); 
