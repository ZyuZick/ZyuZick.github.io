...
class ControllerExtensionModuleSodeals extends Controller {
	...
	if (!isset($this->request->get['module_id'])) {
		...
		$data['store_layouts'] = array(
			...
			'home6' 	=> $this->language->get('value_default2')	,
			'home8' 	=> $this->language->get('value_default3')	,
			'home9' 	=> $this->language->get('value_default4')	,
			'home10' 	=> $this->language->get('value_default5')
		);
