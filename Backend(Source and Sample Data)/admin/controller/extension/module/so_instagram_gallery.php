...
class ControllerExtensionModuleSoinstagramgallery extends Controller {
	...
	public function index() {
		...
		if( isset($this->request->get['module_id']) && isset($this->request->get['delete']) ){
			...
			$this->response->redirect($this->url->link('extension/module/so_instagram_gallery', 'token=' . $this->session->data['token'], 'SSL'));
		}
		// Get module id new 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				...
				$this->model_extension_module->addModule('so_instagram_gallery', $this->request->post);
			...
			if($action == "save_edit") {
				$this->response->redirect($this->url->link('extension/module/so_instagram_gallery', 'module_id='.$module_id.'&token=' . $this->session->data['token'], 'SSL'));
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/so_instagram_gallery', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/so_instagram_gallery', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$data['moduletabs'] = $this->model_extension_module->getModulesByCode( 'so_instagram_gallery' );
		$data['link'] = $this->url->link('extension/module/so_instagram_gallery', 'token=' . $this->session->data['token'] . '', 'SSL');
		$data['linkremove'] = $this->url->link('extension/module/so_instagram_gallery&token=' . $this->session->data['token']);
