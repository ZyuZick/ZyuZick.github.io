...
function guten_shop_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			...
			'priority' => 0,
			'description' => __('<h3>Documentation</h3><p>Click the button below to view Gutenshop theme documentation and F.A.Q where we answer the most common questions on how to use this theme.</p>
