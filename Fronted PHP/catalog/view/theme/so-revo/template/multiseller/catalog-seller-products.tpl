		...
		<div class="info-box">
			...
			<div>
				<ul class="list-unstyled">
					...
					<li class="site"><a target="_blank" href="<?php echo $seller['settings']['slr_website'] ;?>"><?php echo $seller['settings']['slr_website'] ;?></a></li>
					<li><?php echo trim($seller['settings']['slr_city'] . ', ' . $seller['settings']['slr_country'], ',') ;?></li>
				</ul>
			</div>
			
			<div class="button-all">
			<a href="<?php echo $seller['href']; ?>" class="all btn-block" style="clear: both">
							...
							<div class="right-block">
								...
								<div class="button-group">
									<div class="button-inner">
										<button  class="bts addToCart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span></button>
